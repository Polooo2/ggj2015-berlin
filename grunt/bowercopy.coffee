module.exports =
  development:
    files:
      'build/debug/js/almond.js': 'almond/almond.js'
      'build/debug/js/animframe.js': 'animframe/dist/animframe.js'
      ...
      'build/debug/js/jquery.js': 'jquery/jquery.js'
      'build/debug/js/jquery.typed.js': 'typed.js/js/typed.js'
